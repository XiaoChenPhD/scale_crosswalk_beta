...
df_long$Models <- factor(df_long$Models, levels = c("Pharmacotherapy Equipercentile Model", "rTMS Equipercentile Model", "Linear Regression", "RF Regression", "SVR"), ordered = TRUE)
...
ggsave(file.path(output_dir, "primary_H2M_legend.png"), height = my_height, width = my_width, units = "cm", dpi = 1200)
...
ggsave(file.path(output_dir, "primary_M2H_v2.png"), height = my_height, width = my_width, units = "cm", dpi = 1200)
```
...
ggsave(file.path(output_dir, "folllowup_H2M_legend.png"), height = my_height, width = my_width, units = "cm", dpi = 1200)
...
ggsave(file.path(output_dir, "folllowup_M2H_v2.png"), height = my_height, width = my_width, units = "cm", dpi = 1200)
```
