...
custom_colors <- c("Pharmacotherapy Equipercentile Model" = "#6C946F", "Linear Regression" = "#D4BDAC", "rTMS Equipercentile Model" = "#FFA823", "RF Regression" = "#DC0083", "SVR" = "#536493", "SVR Item" = "#8CB9BD", "SVR Cov" = "#E7F0DC", "SVR Item Cov" = "#B6C7AA")
```
...
rownames(data_matrix) <- c("Pharmacotherapy Equipercentile Model", "rTMS Equipercentile Model", "Linear Regression", "RF Regression", "SVR")
...
df_long$Models <- factor(df_long$Models, levels = c("Pharmacotherapy Equipercentile Model", "Spacer", "rTMS Equipercentile Model", "Linear Regression", "RF Regression", "SVR"), ordered = TRUE)
...
ggsave(file.path(output_dir, "primary_H2M_spaced.png"), height = my_height, width = my_width, units = "cm", dpi = 1200)
...
ggsave(file.path(output_dir, "primary_M2H_spaced.png"), height = my_height, width = my_width, units = "cm", dpi = 1200)
```
...
ggsave(file.path(output_dir, "folllowup_H2M_spaced.png"), height = my_height, width = my_width, units = "cm", dpi = 1200)
...
ggsave(file.path(output_dir, "folllowup_M2H_spaced.png"), height = my_height, width = my_width, units = "cm", dpi = 1200)
```
