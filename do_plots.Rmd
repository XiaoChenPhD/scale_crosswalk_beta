...
ggsave(file.path(output_dir, "primary_H2M_v2.png"), height = my_height, width = my_width, units = "cm", dpi = 1200)
...
ggsave(file.path(output_dir, "folllowup_H2M_v2.png"), height = my_height, width = my_width, units = "cm", dpi = 1200)
...
ggsave(file.path(output_dir, "baseline_model_H2M_v2.png"), height = my_height, width = my_width, units = "cm", dpi = 1200)
...
ggsave(file.path(output_dir, "Item_compare_H2M_v2.png"), height = my_height, width = my_width, units = "cm", dpi = 1200)
...
df_long <- df_H2M %>% 
  pivot_longer(cols = c("Baseline", "T30", "Delta"),
               ...
               values_to = "RMSE")
df_long$`Time point` <- factor(df_long$`Time point`, levels = c("Delta", "T30", "Baseline"), ordered = TRUE)
df_long$Models <- factor(df_long$Models, levels = c("SVM Regression", "SVM Regression Cov", "SVM Regression Item", "SVM Regression Item Cov"), ordered = TRUE)
df_long$Models <- factor(df_long$Models, levels = rev(levels(df_long$Models)))
...
ggsave(file.path(output_dir, "Cov_compare_H2M_v2.png"), height = my_height, width = my_width, units = "cm", dpi = 1200)
```
